...
export default function SeekerSupportScreen() {
  ...
  const handleWhatsApp = async () => {
    try {
      const text = encodeURIComponent(
        "Hello StayRent Support, I need help with my seeker account."
      );
  ...
  const handleEmail = async () => {
    try {
      const subject = encodeURIComponent(
        "StayRent Seeker Support"
      );

      const body = encodeURIComponent(
        "Hello StayRent Support,\n\nI need help with my seeker account.\n\nProblem:"
      );
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <TextInput
          ...
          placeholder="Example: I am unable to find or open a property..."
